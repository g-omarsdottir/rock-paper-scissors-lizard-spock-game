...
![javascript-validator](/documentation/jshint-report.png)
...
| Button Return to Home  | Click button | user navigates to landing page section                                           |                                                                                                          |
| Screen reader          | Perform all aforementioned tests using screen reader and keyboard control                             | Add attributes to improve use with assisting technology (see section [accessibility](#accessibility))                      |
